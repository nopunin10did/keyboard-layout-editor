...
(function () {
	...
	var unitSizes = {
		px : {
			...
			"DSS" : { profile: "DSS", keySpacing: 0, bevelMargin: 6, bevelOffsetTop: 0, bevelOffsetBottom: 0, padding: 3, roundOuter: 5, roundInner: 8 },
		...
		mm : {
			...
			"DSS" : {  profile: "DSS", keySpacing: 0.4445, bevelMargin: 3.1115, padding: 0, roundOuter: 1.0, roundInner: 2.0 },
	...
	["px","mm"].forEach(function(unit) {
		["","DCS","DSA","SA","DSS","CHICKLET","FLAT"].forEach(function(profile) {
	...
	function getProfile(key) {
		return (/\b(SA|DSA|DCS|DSS|OEM|CHICKLET|FLAT)\b/.exec(key.profile) || [""])[0];
	}
